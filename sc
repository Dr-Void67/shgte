...
local Window = Rayfield:CreateWindow({
   ...
   KeySettings = {
      Title = "Key sys",
      Subtitle = "Key System",
      Note = "DM averyfunnyguywhoreallylovescats on discord", -- Use this to tell the user how to get a key
      ...
      Key = {"Lok1-A4GHEK683&!74hJ83$#29$259-2*04"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
   }
})
